package per.meteor.springboot.common.constanst;
...
public abstract class DatePattern {
     ...
     * 13位时间戳正则表达式
     */
    public static final String REGEX_TIME_STAMP = "1\\d{12}";

    /**
     * 年和月正则表达式
     */
    public static final String REGEX_NORM_YEAR_MONTH = "\\d{4}-\\d{1,2}";

    /**
     * 日期正则表达式
     */
    public static final String REGEX_NORM_DATE = "\\d{4}-\\d{1,2}-\\d{1,2}";

    /**
     * 时间正则表达式
     */
    public static final String REGEX_NORM_TIME = "\\d{1,2}(:\\d{1,2})?)?(.\\d{1,6})?";

    /**
     * 日期时间正则表达式
     */
    public static final String REGEX_NORM_DATE_TIME = "\\d{4}-\\d{1,2}-\\d{1,2}(\\s\\d{1,2}:\\d{1,2}(:\\d{1,2})?)?(.\\d{1,6})?";
     ...
     *
     */
    public static final Pattern REGEX_NORM = Pattern.compile(REGEX_NORM_DATE_TIME);
